<div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
    ...
    >
        <span class="text-xl font-bold">Find job opportunities</span>
...
{{--        href="{{route('interview-preparation-study-plan')}}"--}}
    ...
    <a class="bg-white rounded-lg shadow-md border border-black border-solid p-6 hover:bg-gray-50 transition-colors duration-300 flex flex-col items-center gap-2 max-w-xs">
        <span class="text-xl font-bold">Check your messages</span>
    </a>
</div>
